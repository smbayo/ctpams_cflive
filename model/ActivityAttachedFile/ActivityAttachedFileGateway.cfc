...
<cfcomponent displayname="ActivityAttachedFileGateway" output="false">
	<cfproperty name="dsn" inject="coldbox:datasource:theDSN" />

	<cffunction name="init" access="public" output="false" returntype="ActivityAttachedFileGateway">
		<cfreturn this />
	</cffunction>
	...
	<cffunction name="getActivityFilesQuery" access="public" output="false" returntype="query">
		...
		<cfset var qList = "" />		
		<cfquery name="qList" datasource="#dsn.getName()#">
			SELECT * from Q_ActivityAttachedfiles WHERE	0=0
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","ActivityAttachedFile").init(argumentCollection=queryRowToStruct(qList,i)) />
