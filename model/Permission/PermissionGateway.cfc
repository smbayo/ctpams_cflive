...
<cfcomponent displayname="PermissionGateway" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="PermissionGateway">
		<cfreturn this>
	</cffunction>
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","Permission").init(argumentCollection=queryRowToStruct(qList,i)) />
	...
	<cffunction name="getAllPermissions" access="public" output="false" returntype="query">
		
		<cfset var qPermissionss = "" />		
		<cfquery name="qPermissions" datasource="#dsn.getName()#">
			SELECT
				SysPermissionID,
				Name,
				Description
			FROM	SysPermission
			ORDER BY SysPermissionID
		</cfquery>
