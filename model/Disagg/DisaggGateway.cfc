...
<cfcomponent displayname="DisaggGateway" output="false">

	<cfproperty name="dsn" inject="coldbox:datasource:theDSN" />
	
	<cffunction name="init" access="public" output="false" returntype="DisaggGateway">
		<cfreturn this />
	</cffunction>
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","Disagg").init(argumentCollection=queryRowToStruct(qList,i)) />
