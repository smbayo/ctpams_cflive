...
<cfcomponent displayname="ActivityCategoryDAO" hint="table ID column = ActivityCategoryID">

	<cfproperty name="dsn" inject="coldbox:datasource:theDSN" />
	
	<cffunction name="init" access="public" output="false" returntype="ActivityCategoryDAO">
		<cfreturn this>
	</cffunction>
	...
	<cffunction name="read" access="public" output="false" returntype="void">
		...
		<cftry>
			<cfquery name="qRead" datasource="#dsn.getName()#">
				...
				WHERE	ActivityCategoryID = <cfqueryparam value="#arguments.ActivityCategory.getActivityCategoryID()#" CFSQLType="cf_sql_integer" />
			</cfquery>
			<cfcatch type="database">
		...
		<cfif qRead.recordCount>
			...
			<cfset arguments.ActivityCategory.init(argumentCollection=strReturn)>
		</cfif>
	</cffunction>
