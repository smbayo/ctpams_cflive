...
<cfcomponent displayname="ActivityCategoryGateway" output="false">
	...
	<cffunction name="init" access="public" output="false" returntype="ActivityCategoryGateway">
		<cfreturn this />
	</cffunction>
	...
	<cffunction name="getByAttributesQuery" access="public" output="false" returntype="query">
		...
		<cfif structKeyExists(arguments,"ActivityCategoryID") and len(arguments.ActivityCategoryID)>
			AND	ActivityCategoryID = <cfqueryparam value="#arguments.ActivityCategoryID#" CFSQLType="cf_sql_integer" />
		</cfif>
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","ActivityCategory").init(argumentCollection=queryRowToStruct(qList,i)) />
