	...
	<table style="background:transparent; background-color:#a6a6a6; width=100%" width="100%">
		<tr valign="middle">
			...
			<td>
				...
				<span style="color: white; font-size: 20px;">Program Funding</span><br>
				<span style="color: #254061; font-size: 26px;"><cfoutput>#rc.programname#</cfoutput></span>
			</td>
		</tr>
	</table><br>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <thead>
  <tr style='page-break-inside:avoid;height:20.25pt'>
   ...
   color:white'><cfoutput>#rc.programname#</cfoutput> CT Projects</span></p>
   </td>
  </tr>
...
<cfheader name="Content-Disposition" value="attachment; filename=programprofile.doc"/>
