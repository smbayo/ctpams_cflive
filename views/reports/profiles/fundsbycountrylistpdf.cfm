	...
	<table style=" background-color:#a6a6a6; width=100%" width="100%" cellspacing="14" cellpadding="0">
		<tr valign="middle">
			...
			<td><span style="color: #ffffff; font-size: 11px;">
				...
				<span style="color: #ffffff; font-size: 18px;">Country Funding<br></span>
...
<table cellspacing="0" cellpadding="5" align=center width="100%">
 <thead>
  <tr>
   ...
   <cfoutput>#rc.countryname#</cfoutput> CT Projects
   </td>
  </tr>
  <tr>
...
<cfif len(rc.groupfunding)>
	...
	<tr><td colspan="8" style='border-top:solid black 1.0pt;border-left:solid black 1.0pt;border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;font-family:arial,sans-serif;'><strong>#fundstype#</strong></td></tr>
	<cfoutput>
	 <tr>
  ...
  <td valign="top" style='border-top:solid black 1.0pt;border-left:none;border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;font-family:arial,sans-serif;'>
  <Cfif ListLen(countries) gt 3>#ListLen(countries)# Countries<cfelse>#countries#</cfif>
  </td>
  <td valign="top" style='border-top:solid black 1.0pt;border-left:none;border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;font-family:arial,sans-serif;'>
...
<p class=MsoNormal>&nbsp;</p>
 ...
 <span style='font-size:12.0pt;
  ...
  $ requested for projects including <cfoutput>#rc.countryname#</cfoutput>:<b><cfoutput>#Demoronize(trim(dollarFormat(totalall)))#</cfoutput></b></span><br>
<span style='font-size:12.0pt;
  font-family:"Arial","sans-serif"'>Total requested
  $ allocated to <cfoutput>#rc.countryname#</cfoutput> for projects in <cfif rc.fy is "">FY2010-FY<CFOUTPUT>#year(now())#</CFOUTPUT><cfelse>FY<cfoutput>#rc.fy#</cfoutput></cfif>:<b><cfoutput>#Demoronize(trim(dollarFormat(totalcountry)))#</cfoutput></b></span>
</body>
