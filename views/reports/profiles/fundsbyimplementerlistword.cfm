	...
	<table style="background:transparent; background-color:#a6a6a6; width=100%" width="100%">
		<tr valign="middle">
			...
			<td>
				...
				<span style="color: white; font-size: 20px;">Implementing Partner Funding</span><br>
				<span style="color: #254061; font-size: 26px;"><cfoutput>#rc.implementer#</cfoutput></span>
			</td>
		</tr>
	</table><br>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <thead>
  <tr style='page-break-inside:avoid;height:20.25pt'>
   <td nowrap colspan=7 valign=bottom style='
   ...
   color:white'><cfoutput>#rc.implementer#</cfoutput> CT Projects</span></p>
   </td>
  </tr>
  <tr style='page-break-inside:avoid;height:51.0pt'>
   ...
   <td width=370 valign=bottom style='width:300.0pt;border:none;border-right:
   solid windowtext 1.0pt;background:#254061;padding:0in 5.4pt 0in 5.4pt;
   height:51.0pt'>
   <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
   text-align:center;line-height:normal'><b><span style='font-size:10.0pt;
   ...
   <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
   text-align:center;line-height:normal'><b><span style='font-size:10.0pt;
   font-family:"Arial","sans-serif";color:white'>Program</span></b></p>
   </td>
...
<cfif len(implementationstatus) gt 0 and activitystatus is "program fully obligated">
  ...
  <td width=370 nowrap valign=bottom style='width:300.0pt;border:solid windowtext 1.0pt;
  ...
  border-left:none;padding:0in 5.4pt 0in 5.4pt;height:64.3pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:10.0pt;font-family:"Arial","sans-serif"'>#Demoronize(trim(programname))#</span></p>
  </td>

  <td width=36 valign=bottom style='width:27.0pt;border:solid windowtext 1.0pt;
  border-left:none;padding:0in 0in 0in 0in;height:64.3pt'>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
...
<p class=MsoNormal>&nbsp;</p>
 ...
 <span style='font-size:12.0pt;
  ...
  $ requested for projects including <cfoutput>#rc.implementer#</cfoutput>:<b><cfoutput>#Demoronize(trim(dollarFormat(totalall)))#</cfoutput></b></span><br>
...
<cfheader name="Content-Disposition" value="attachment; filename=implementerprofile.doc"/>
