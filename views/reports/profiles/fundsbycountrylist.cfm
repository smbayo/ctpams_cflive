<ol class="breadcrumb">
  <li>Charts</li>
  <li><cfoutput><a href="#event.buildLink("reports/filteredchartbycountry")#?#getPlugin('SessionStorage').getVar('countrychartquerystring')#"></cfoutput>Country Chart</a></li>
<li class="active">Country Profile</li>
</ol>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<form action="<cfoutput>#event.buildLink('reports/fundsbycountrylistword?fy=#rc.fy#&programname=#rc.program#&countryname=#rc.countryname#&statusID=#rc.statusID#&program=#rc.program#')#</cfoutput>" method="post">
			...
			<!--- <input type="checkbox" name="groupfunding" value="1"> Group Funds --->
		...
		<select id="country" name="countryname" style="visibility: hidden;">
			<cfloop query="rc.countries">
        	  <option value="#name#" <cfif rc.countryname is '#name#'>selected</cfif>>#name#</option>
			</cfloop>
        </select>
		...
		<input type="hidden" name="region" value="#rc.region#">
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-bar-chart-o fa-fw"></i> <cfoutput>#rc.countryname#</cfoutput> - Activity Expenditures
				<div class="pull-right">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-pie-chart fa-fw"></i> <cfoutput>#rc.countryname#</cfoutput> - Program Budget Breakdown
				<div class="pull-right">
	...
	<div id="fcexpDiv" align="center">FusionCharts Export Handler Component</div>
			...
			<script language="JavaScript">
				...
				var chartHeight = 420;
					...
					myChart.setXMLUrl("<cfoutput>#event.buildLink(URLEncodedFormat('reports/filteredchartxml?fy=#rc.fy#&region=#rc.region#&countryname=#rc.countryname#&programname=#rc.program#&statusID=#rc.statusID#'))#</cfoutput>");
					...
					myChart2.setXMLUrl("<cfoutput>#event.buildLink(URLEncodedFormat('reports/filteredexpenditurechartxml?fy=#rc.fy#&region=#rc.region#&countryname=#rc.countryname#&programname=#rc.program#&statusID=#rc.statusID#'))#</cfoutput>");
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-eye fa-fw"></i> <cfoutput>#rc.countryname#</cfoutput> - Projects
				<div class="pull-right">
					...
					<table class="table table-striped table-hover" id="filteredreport">
						...
						<thead>
							<tr>
								...
								<th><span data-toggle="tooltip" title="Estimated Funds for <cfoutput>#rc.countryname#</cfoutput> specifically from project">Project <i class="icon-question-sign"></i> </th>
						...
						<tbody>
							...
							<tr>
								<td>
										<a href=#event.buildLink("proposal.review.activityID." & rc.byCountry.ActivityID)# title="#proposalname#" data-toggle="tooltip" data-placement="right">#uCase(proposalNumber)#</a>

								</td>
								<td>
										<a href=#event.buildLink("proposal.review.activityID." & rc.byCountry.ActivityID)# title="#proposalname#" data-toggle="tooltip" data-placement="right">#proposalname#</a>
