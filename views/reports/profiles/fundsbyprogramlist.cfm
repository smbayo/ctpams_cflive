<ol class="breadcrumb">
  <li>Charts</li>
  <li><cfoutput><a href="#event.buildLink("reports/filteredchartbyprogram")#?#getPlugin('SessionStorage').getVar('programchartquerystring')#"></cfoutput>Program Chart</a></li>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<form action="<cfoutput>#event.buildLink('reports/fundsbyprogramlistword?fy=#rc.fy#&countryname=#rc.countryname#&program=#rc.program#&programname=#rc.program#&region=#rc.region#&statusID=#rc.statusID#')#</cfoutput>" method="post">
		...
		<cfoutput>
		<form>
		<select id="program" name="program" style="visibility: hidden;">
			<cfloop query="rc.programs">
        	  <option value="#name#" <cfif rc.program is '#name#'>selected</cfif>>#name#</option>
			</cfloop>
		...
		<cfif structKeyExists(rc,"byprogram")  AND rc.byprogram.recordCount>
...
<div class="row">
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-bar-chart-o fa-fw"></i> <cfoutput>#rc.program#</cfoutput> - Activity Expenditures
				<div class="pull-right">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-pie-chart fa-fw"></i> <cfoutput>#rc.program#</cfoutput> - Program Budget Breakdown
				<div class="pull-right">
	...
	<div id="fcexpDiv" align="center">FusionCharts Export Handler Component</div>
			...
			<script language="JavaScript">
				...
				var chartHeight = 420;
					...
					myChart.setXMLUrl("<cfoutput>#event.buildLink(URLEncodedFormat('reports/filteredchartbyregionxml?fy=#rc.fy#&region=#rc.region#&program=#rc.program#&countryname=#rc.countryname#&statusID=#rc.statusID#'))#</cfoutput>");
					...
					myChart2.setXMLUrl("<cfoutput>#event.buildLink(URLEncodedFormat('reports/filteredexpenditurechartxml?fy=#rc.fy#&region=#rc.region#&programname=#rc.program#&countryname=#rc.countryname#&statusID=#rc.statusID#'))#</cfoutput>");
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-eye fa-fw"></i> <cfoutput>#rc.program#</cfoutput> - Projects
				<div class="pull-right">
					...
					<table class="table table-striped table-hover" id="filteredreport">
						...
						<tbody>
							...
							<tr class="sectionReview first">
								<td>
										<a href=#event.buildLink("proposal.review.activityID." & rc.byprogram.ActivityID)# title="#proposalname#" data-toggle="tooltip" data-placement="right">#uCase(proposalNumber)#</a>

								</td>
								<td>
										<a href=#event.buildLink("proposal.review.activityID." & rc.byprogram.ActivityID)# title="#proposalname#" data-toggle="tooltip" data-placement="right">#proposalname#</a>
