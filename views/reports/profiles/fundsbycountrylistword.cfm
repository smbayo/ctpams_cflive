	...
	<table style="background:transparent; background-color:#a6a6a6; width=100%" width="100%">
		<tr valign="middle">
			...
			<td>
				...
				<span style="color: white; font-size: 20px;">Country Funding</span><br>
				<span style="color: #254061; font-size: 26px;"><cfoutput>#rc.countryname#</cfoutput></span>
			</td>
		</tr>
	</table><br>
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <thead>
  <tr style='page-break-inside:avoid;height:20.25pt'>
   ...
   color:white'><cfoutput>#rc.countryname#</cfoutput> CT Projects</span></p>
   </td>
  </tr>
  <tr style='page-break-inside:avoid;height:51.0pt'>
   ...
   <td valign=bottom style='width:230.0pt;border:none;border-right:
   solid windowtext 1.0pt;background:#254061;padding:0in 5.4pt 0in 5.4pt;
   height:51.0pt'>
   <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
   text-align:center;line-height:normal'><b><span style='font-size:10.0pt;
   ...
   <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
   text-align:center;line-height:normal'><b><span style='font-size:10.0pt;
   font-family:"Arial","sans-serif";color:white'>Countries</span></b></p>
   </td>
   ...
   color:white'>Estimated Funds for <cfoutput>#rc.countryname#</cfoutput> specifically from project</span></b></p>
   </td>--->
   <td width=96 valign=bottom style='width:1.0in;border:none;border-right:solid windowtext 1.0pt;
   background:#254061;padding:0in 5.4pt 0in 5.4pt;height:51.0pt'>
   <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;
...
<cfoutput query="rc.byCountry" group="fundstype">
	<tr><td colspan="8" style='
   border:solid windowtext 1.0pt;background:##254061;padding:0in 5.4pt 0in 5.4pt;
   height:20.25pt'><p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;
   line-height:normal'><span style='font-size:16.0pt;font-family:"Arial","sans-serif";
   color:white'>#fundstype#</span></p></td></tr>
	<cfoutput>
 <tr style='page-break-inside:avoid;height:64.3pt'>
  ...
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:10.0pt;font-family:"Arial","sans-serif"'>#Demoronize(trim(proposalname))#</span></p>
  </td>
  ...
  <td nowrap valign=bottom style='width:230.0pt;border:solid windowtext 1.0pt;
  border-left:none;padding:5.4pt 5.4pt 0in 5.4pt;height:64.3pt'>
  ...
  border-left:none;padding:0in 5.4pt 0in 5.4pt;height:64.3pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><span style='font-size:10.0pt;font-family:"Arial","sans-serif"'><Cfif ListLen(countries) gt 3>#ListLen(countries)# Countries<cfelse>#countries#</cfif></span></p>
  </td>
...
<p class=MsoNormal>&nbsp;</p>
 ...
 <span style='font-size:12.0pt;
  font-family:"Arial","sans-serif"'>Total $ requested for projects including <cfoutput>#rc.countryname#</cfoutput>:<b><cfoutput>#Demoronize(trim(dollarFormat(totalall)))#</cfoutput></b></span><br>
<span style='font-size:12.0pt;
  font-family:"Arial","sans-serif"'>Total requested $ allocated to <cfoutput>#rc.countryname#</cfoutput> for projects in <cfif rc.fy is "">FY2010-FY<CFOUTPUT>#year(now())#</CFOUTPUT><cfelse>FY<cfoutput>#rc.fy#</cfoutput></cfif>:<b><cfoutput>#Demoronize(trim(dollarFormat(totalcountry)))#</cfoutput></b> </span>
</body>
...
<cfheader name="Content-Disposition" value="attachment; filename=countryprofile.doc"/>
