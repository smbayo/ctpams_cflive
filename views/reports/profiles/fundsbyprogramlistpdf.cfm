	...
	<table style=" background-color:#a6a6a6; width=100%" width="100%" cellspacing="14" cellpadding="0">
		<tr valign="middle">
			...
			<td><span style="color: #ffffff; font-size: 11px;">
				...
				<span style="color: #ffffff; font-size: 18px;">Program Funding<br></span>
...
<table cellspacing="0" cellpadding="5" align=center width="100%">
 <thead>
  <tr>
   <td nowrap colspan="7"style='border:solid black 1.0pt;background:#254061;color:white;font-size:16.0pt;font-family:arial,sans-serif;'>
   <cfoutput>#rc.programname#</cfoutput> CT Projects
   </td>
  </tr>
  <tr>
...
<p class=MsoNormal>&nbsp;</p>
 ...
 <span style='font-size:12.0pt;
  ...
  $ requested for projects including <cfoutput>#rc.programname#</cfoutput>:<b><cfoutput>#Demoronize(trim(dollarFormat(totalall)))#</cfoutput></b></span><br>
<span style='font-size:12.0pt;
  font-family:"Arial","sans-serif"'>Total requested
  $ allocated to <cfoutput>#rc.programname#</cfoutput> for projects in <cfif rc.fy is "">FY2010-FY<CFOUTPUT>#year(now())#</CFOUTPUT><cfelse>FY<cfoutput>#rc.fy#</cfoutput></cfif>:<b><cfoutput>#Demoronize(trim(dollarFormat(totalcountry)))#</cfoutput></b></span>
</body>
