<ol class="breadcrumb">
  <li>Charts</li>
  <li class="active">Country Chart</li>
</ol>
...
<cfset rc.countrychartquerystring = getPlugin("SessionStorage").setVar("countrychartquerystring",CGI.QUERY_STRING)>
<div class="row">
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<div class="pull-right">
					<a href="<cfoutput>#event.buildLink("reports/filteredchartbycountry")#</cfoutput>" class="btn btn-default btn-xs">Clear Filters</a>
				</div>
			</div>
            <!-- /.panel-heading -->
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-bar-chart-o fa-fw"></i> Country Chart <span class="text-muted"> (click on chart to access country profiles)</span>
				<div class="pull-right">
	...
	<script language="JavaScript">
			...
			var chartHeight = 1800;
			var myChart = new FusionCharts("<cfoutput>#pathString##chartfile#</cfoutput>","myChartId", chartWidth, chartHeight, "0", "1" );
			myChart.setXMLUrl("<cfoutput>#event.buildLink(URLEncodedFormat('reports/filteredchartbycountryxml?fy=#rc.fy#&program=#rc.program#&region=#rc.region#&statusID=#rc.statusID#&themeID=#rc.themeID#'))#</cfoutput>");
