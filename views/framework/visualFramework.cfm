...
<cfif (isUserInRole('edit results'))>
	<FORM METHOD="LINK" ACTION="index.cfm/framework/editResult">
	...
	<div id="chart"></div>
        ...
        <!--Dependency scripts-->
        <script src="includes/javascript/visualization/jquery-1.7.2.min.js"></script>
        <script src="includes/visualization/jquery.simplemodal.1.4.2.min.js"></script>
        <script src="includes/javascript/visualization/d3.v2.min.js"></script>
        <script src="includes/javascript/visualization/helper_functions.min.js"></script>
        <script src="includes/javascript/visualization/textFlow.min.js"></script>

        <!--Main script that draws the RF Tree-->
	<script src="includes/javascript/visualization/rfTree_inter.js"></script>
